...
import museum from './images/gal1.jpg';
import hospital from './images/gal3.jpg';
import tower from './images/gal2.jpg';
import seema from './images/gal4.jpeg';
import Red_Mosque from './images/gal5.jpg';
import portcity from './images/gal6.jpg';
import colompo from './images/gal2.jpg'; 
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">  {/* Changed from py-0 to py-2 to add a little space */}
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of Galle"
          ...
          >
            The Ancient Wonders of export default Galle
          </h1>
...
export default GalleDetailsPage;