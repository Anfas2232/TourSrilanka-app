...
import museum from './images/be1.jpg';
import hospital from './images/be3.jpg';
import tower from './images/be2.jpg';
import seema from './images/be4.jpg';
import Red_Mosque from './images/be5.jpg';
import portcity from './images/be6.jpg';
import colompo from './images/be3.jpg';
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">  {/* Changed from py-0 to py-2 to add a little space */}
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of Bentota"
          ...
          >
            The Ancient Wonders of export default Bentota
...
export default BentotaDetailsPage;