...
import museum from './images/ya1.jpg';
import hospital from './images/ya3.jpg';
import tower from './images/ya2.jpg';
import seema from './images/ya4.jpg';
import Red_Mosque from './images/ya5.jpg';
import portcity from './images/ya6.jpg';
import colompo from './images/ya1.jpg';
...
const YalaNationalParkDetailsPage = () => {
  const attractions = [
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-5 flex-grow-1">
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of YalaNationalPark"
          ...
          >
            The Ancient Wonders of YalaNationalPark
          </h1>
...
export default YalaNationalParkDetailsPage;
