...
//   // Add all other places from your original data here
//   // ...
...
//   return (R * c).toFixed(1); // distance in km with 1 decimal place
// }

// // Component to handle marker click and map animation
// function MapClickHandler({ lat, lng }) {
//   const map = useMap(); // Get the map instance

//   const handleMarkerClick = () => {
//     map.flyTo([lat, lng], 10, { // Zoom to level 10 with smooth animation
//       animate: true,
...
//             html: `<div class="circle-icon" style="
...
//               eventHandlers={{
//                 click: (e) => {
//                   // Access the map instance from the event target
...
//                     }}
//                   >
//                     <h5 style={{ margin: 0, fontWeight: '700', fontSize: '1.2rem', color: '#34495e', display: 'flex', alignItems: 'center' }}>
