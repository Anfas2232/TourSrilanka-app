...
import museum from './images/ar1.jpg';
import hospital from './images/ar3.jpg';
import tower from './images/ar2.jpg';
import seema from './images/ar4.jpg';
import Red_Mosque from './images/ar5.jpg';
import portcity from './images/ar6jpg.jpg';
import colompo from './images/ar1.jpg';
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">  {/* Changed from py-0 to py-2 to add a little space */}
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of ArugamBay"
          ...
          >
            The Ancient Wonders of ArugamBay
          </h1>
...
export default ArugamBayDetailsPage;