...
import museum from './images/kan1.jpg';
import hospital from './images/kan2.jpg';
import tower from './images/ka.jpg';
import seema from './images/kan.jpeg';
import Red_Mosque from './images/tea.jpeg';
import portcity from './images/kan6.jpg';
import colompo from './images/kan.jpeg';
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">  {/* Changed from py-0 to py-2 to add a little space */}
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of Kandy"
...
export default KandyDetailsPage;
