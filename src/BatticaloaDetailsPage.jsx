...
import museum from './images/bat1.jpg';
import hospital from './images/bat3.jpg';
import tower from './images/bat2.jpg';
import seema from './images/bat4.jpg';
import Red_Mosque from './images/bat5.jpg';
import portcity from './images/bat6.jpg';
import colompo from './images/bat4.jpg';
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">  {/* Changed from py-0 to py-2 to add a little space */}
        <div className="main-content-column">
            ...
            <HeroSection
                title="Explore the Wonders of Batticaloa"
          ...
          >
            The Ancient Wonders of Batticaloa
          </h1>
...
export default BatticaloaDetailsPage;